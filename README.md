...
- Consulta ao perfil dos profissionais;
...
Nessa página, é possível visualizar os profissionais disponíveis, suas especialidades, avaliações e acessar seus perfis.

Também trabalhei na organização visual dos cards dos profissionais, incluindo:
...
Também desenvolvi a página `perfil.html` e seu arquivo `perfil.css`.

A página apresenta informações detalhadas sobre o profissional, incluindo:

- Foto e nome do profissional;
- Especialidades;
- Registro profissional;
- Avaliação;
- Informações sobre sua abordagem;
- Experiências;
- Serviços oferecidos;
- Opção para iniciar o agendamento de uma consulta.
...
Essa área foi criada para representar o ambiente do profissional, permitindo visualizar:

- Consultas agendadas;
- Horários dos atendimentos;
- Informações dos pacientes;
- Opção de iniciar uma sessão;
- Visualização de detalhes de consultas;
